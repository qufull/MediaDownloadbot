...
class PinterestContentType(Enum):
    """Типы контента Pinterest."""
    PIN = "pin"
    BOARD = "board"
    STORY = "story"
    UNKNOWN = "unknown"
    # Оставили POST для обратной совместимости с логикой определения контента
    POST = "post"


class PinterestErrorCode(Enum):
    """Коды ошибок, возникающих при работе с Pinterest."""
    ...
    POST_NOT_FOUND = "POST_NOT_FOUND"  # Пин не найден
    POST_CHANGED = "POST_CHANGED"  # Пин изменился или удален
