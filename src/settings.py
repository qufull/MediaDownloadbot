...
class YoutubeSettings(BaseSettings):
    """Фичефлаги YouTube — меняй .env, не код."""
    model_config = SettingsConfigDict(env_file=".env", env_file_encoding="utf-8", extra="ignore")
    player_client: Annotated[str, Field(default="default", validation_alias="YOUTUBE_PLAYER_CLIENT")]
    player_js_variant: Annotated[Optional[str], Field(default=None, validation_alias="YOUTUBE_PLAYER_JS_VARIANT")]
